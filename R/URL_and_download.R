#' URL Builder
#'
#' This function allows you to build a URL for using the function download_football_data()
#' @param league_url_name An unique name for the leaugue used in the URL. Copy this one from kicker.de!
#' @param season The season you are interested in. Since a season always lasts from summer to summer, these are two years. The format is "YYYY-YY" and the default value is "2018-19". Please make sure, the season of interest is still/already online.
#' @examples
...
#' @param league_url The URL of the kicker.de webpage of the league of interest. Please create this with amateuR::build_league_url(). Alternativly you can copy & paste it manually, but make sure it ends with "/-1".
