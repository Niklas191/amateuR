...
#' @param league_url The URL of the kicker.de webpage of the league of interest. Please create this with \code{\link[amateuR]{build_league_url}}. Alternativly you can copy & paste it manually, but make sure it ends with \code{"/-1"}.
